                     ...
                     <div class="col-sm-12 col-xl-6">
                        <div class="bg-light rounded h-100 p-4">
                            ...
                            <form action="../controller/addemployee.php" method="POST">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <?php 
                                    $stmt2=$admin->ret("SELECT DISTINCT designation FROM `employee`");
                        ...
                        <?php }?>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <?php 
                                    $stmt3=$admin->ret("SELECT * FROM `speciality`");
                                    while($row3=$stmt3->fetch(PDO::FETCH_ASSOC))
                                    {
                                     ?>
                                    
                        <option value="<?php echo $row3['speciality'];?>"><?php echo $row3['speciality'];?></option>
                        <?php }?>
                        </select>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="fee" class="form-control" id="inputEmail3">
                                    </div>
                                </div>
                                <div class="row mb-3">
